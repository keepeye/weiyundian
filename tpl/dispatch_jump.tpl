...
.system-message{ padding:0 0 48px;margin:150px auto;min-width:400px;border:5px solid #ccc}
...
<body>
	<div class="system-message">
		<p style="height:35px;background:url(/PigData/conf/images/msg_top_bg.png) #ccc;padding-left:10px;line-height:35px;color:white">微云店提醒</p>
		<div style="padding:24px;">
			<present name="message">		
				...
				<else/>		
				<div class="error"><img style="margin-right: 9px;padding-top:10px;" src="/conf/images/error.png" style="cursor:pointer;"><span style="padding-top:0px;"><?php echo($error); ?>
				</div>
			</present>
